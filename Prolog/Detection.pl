 ...
 * Output: "true" if the degrees are real, "false" otherwise.*/
 ...
 * Input: An integer number.
 * Output: "true" if the primes are real, "false" otherwise.*/
verify_primes(Num) :-
    integer(Num),
    (Num < 0 -> 
        false
 ...
 * Output: "true" if the latters are real, "false" otherwise.*/
verify_latters(Num) :-
    number(Num),
    (Num < 0 -> 
        false
 ...
 * Input: A character.
 * Output: "true" if the character is right, "false" otherwise.*/
verify_lat_sign('N') :- 
    true.
verify_lat_sign('S') :-
    true.
